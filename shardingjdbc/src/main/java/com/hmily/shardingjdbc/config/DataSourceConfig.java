package com.hmily.shardingjdbc.config;
...
import com.hmily.shardingjdbc.config.strategy.ModuloDatabaseShardingAlgorithm;
import com.hmily.shardingjdbc.config.strategy.ModuloTableShardingAlgorithm;
...
@Configuration
@MapperScan(basePackages = "com.hmily.shardingjdbc.mapper", sqlSessionTemplateRef = "test1SqlSessionTemplate")
